...
const journalEntries = [
    ...
    // ============================================
    {
        ...
        date: "June 28, 2026",
        locations: "House",
        events: "Nikoleta came over, lots of math",
        people: "Nikoleta",
        food: ["Breakfast: Yogurt", "[Meal or dish eaten]"],
        feelings: "Did not wanna go to camp tomorow",
        highlights: "Showing Nikoleta slime videos and asking her to rate them",
        mood: "😊",
        rating: 5
    },
    // ============================================
    ...
    // ============================================
    {
        day: 10,
        date: "June 29, 2026",
        locations: "House, camp, organized beach",
        events: "Went to same beach as last monday",
        people: "[Names and descriptions of interesting people you met]",
        food: ["Breakfast:Yogurt", "Breakfast: sesamee bread sticks, 1.5/5"],
    ...
    // ============================================
    {
        day: 12,
        date: "July 1, 2026",
        locations: "House, camp, same beach as last Wednesday but different beach from Monday",
        events: "Went to unorganized beach",
        people: "I became friends with another few girls (still don't know names) and one of the girls also had one of those teeth thingys in her teeth. It was like braces except she took them off before eating.",
        food: ["Breakfast: Yougurt", "Breakfast: Sesamee roll thing, 2/5 ", "Lunch: Weird patty and potatoes, 1/5","Dinner: Roasted chcken legs, 4/5"],
        feelings: "This is my favorite beach of the 2 since it is an unorganized beach which means that it is cleaner but no sunbeds already there. I saw many fish and other kids ate watermelon. There were watermelon chunks in the ocean! I have also noticed that they did not give out a paper today. Usually they give out a slip of paper showing what to bring the next day and where we're going. Tomorow we're going to the waterpark but they did not give out any paper. They also did not give out any paper last week when we were going to the waterpark. Weird.",
        highlights: "The days feel shorter now thankfully and I did lots of Minecraft birthday party planning too. Also the 2nd breakfast thing is at like 9:00 and is more like brunch. The dinner it always at around 5:20 and the lunch is usually at 3:00 (except for Mondays where we eat at the organized beach so that is around 2:00 lunch)",
        mood: "😊",
        rating: 5
    },
    // ============================================
