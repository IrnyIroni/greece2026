...
const journalEntries = [
    ...
    // ============================================
    {
        ...
        people: "IvI was a friend I met at lunch. She's from Sweden ans moved here. (pernounced Eve with all e's being eeeee sound)",
        food: ["Lunch: Noodle pasta, 3/5 rating", "[Meal or dish eaten]"],
    ...
    // ============================================
    {
        ...
        people: "Played with Ivi on waterpaek but she could only go to little kid section",
        food: ["[Meal or dish eaten]", "[Meal or dish eaten]"],
        feelings: "[Your emotions and feelings about today]",
        highlights: "[Other memorable moments or thoughts]",
        mood: "😊",
